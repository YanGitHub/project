...
<div class="row" style="padding-top: 15px">
    ...
    <div class="col-sm-3">
        <div class="input-group input-group-sm">
            <span class="input-group-addon">品类<span style="color: red">*</span></span>
            <select id="categoryCode" name="categoryCode" style="width: 168px"
    ...
    <div class="col-sm-3">
        <div class="input-group input-group-sm">
            ...
            <select id="brandCode" name="brandCode" class="form-control selectpicker" style="width: 168px">
            </select>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    //加载商品品牌
    function loadBrands(){
        $.post('${ctx}/common/getProductBrands', null, function (data) {
            var op = "";
            if (data.length > 0) {
    ...
    function loadCategorys(){
        $.post('${ctx}/common/getProductCategories', null, function (data) {
            var op = "";
            if (data.length > 0) {
                for (var i = 0; i < data.length; i++) {
                    op += "<option value=" + data[i].code + ">" + data[i].name + "</option>";
