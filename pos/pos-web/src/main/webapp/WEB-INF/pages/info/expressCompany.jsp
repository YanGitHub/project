...
<div class="btn-group btn-group-sm">
    ...
    <button class="btn btn-info" onclick="searchExpress()">快递查询</button>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#grid").datagrid({
            url: '${ctx}/expressCompany/getList',
            title: '快递公司',
            singleSelect: true,
            selectOnCheck: false,
            rownumbers: true,
            ...
            columns: [
                [
                    ...
                    { field: 'code', title: '快递代码', fitColumns: true },
                    { field: 'name', title: '快递名称', fitColumns: true},
                    { field: 'outCode', title: '快递100代码', fitColumns: true},
                    { field: 'contact', title: '联系人', fitColumns: true},
                    { field: 'tel', title: '联系人电话', fitColumns: true},
                    ...
                    { field: 'expreeMode', title: '快递模板', fitColumns: true},
