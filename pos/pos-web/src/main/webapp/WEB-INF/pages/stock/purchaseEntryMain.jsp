...
<script type="text/javascript">
var exportUrl = '${ctx}/export/purchaseEntryMainReport';
$(document).ready(function () {
    $("#grid").datagrid({
        url: '${ctx}/stock/purchaseEntryMain/getList',
        title: '采购入库单列表',
        selectOnCheck: true,
        pagination: true,
        rownumbers: true,
        ...
        columns: [
            [
                ...
                { field: 'warehouseName', title: '入库店仓', fitColumns: true},
                ...
                { field: 'faAuditUser', title: '入库人', fitColumns: true},
                { field: 'faAuditDate', title: '入库日期', fitColumns: true},
                { field: 'accountUser', title: '记账人', fitColumns: true},
                { field: 'accountDate', title: '记账日期', fitColumns: true},
...
//跳到新增页面
function create() {
    window.location.href = "${ctx}/stock/purchaseEntryMain/add?id=" + 0;
}
//查看
function see() {
    var item = $('#grid').datagrid('getChecked');
    ...
    window.location.href = "${ctx}/stock/purchaseEntryMain/add?id=" + item[0].id
}
function reset(){
    $('#billNo').val("");
