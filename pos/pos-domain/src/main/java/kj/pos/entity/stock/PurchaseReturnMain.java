...
@Alias("PurchaseReturnMain")
public class PurchaseReturnMain extends BaseEntity implements Serializable{
	//创建字段
	private Long id;//id
	private String billNo;//单据编号
	private String billDate;//单据日期
	private String purchaseReturnTypeCode;//采购退货类型(purchase_return_type code)
    private String purchaseReturnTypeName;
	private String orgCode;//店铺代码(organization_info code)
    private String orgName;
	private String warehouseCode;//退货店仓(warehouse code)
    ...
    public String getPurchaseReturnTypeCode() {
        return purchaseReturnTypeCode;
    }

    public void setPurchaseReturnTypeCode(String purchaseReturnTypeCode) {
        this.purchaseReturnTypeCode = purchaseReturnTypeCode;
    }

    public String getPurchaseReturnTypeName() {
        return purchaseReturnTypeName;
    }

    public void setPurchaseReturnTypeName(String purchaseReturnTypeName) {
        this.purchaseReturnTypeName = purchaseReturnTypeName;
    }
