...
@Alias("PurchaseEntryDetail")
public class PurchaseEntryDetail extends BaseEntity{
	//创建字段
	private Long id;//id
	private Long pid;//采购入库单主表(purchase_entry_main id)
	...
	private Double purchaseQty;//采购数量
	private Double qty;//入库数量
