...
public class PurchaseReturnDetail implements Serializable{
	//创建字段
	private Long id;//id
	private Long pid;//采购退货订单主表(purchase_return_main id)
	...
	private Double cosPrice;//退货单价
	private Double qty;//退货数量
	private Double untAmount;//标准金额=退货数量*标准单价
	private Double comAmount;//退货金额=退货数量*退货单价
